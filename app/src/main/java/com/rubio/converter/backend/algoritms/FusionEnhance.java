package com.rubio.converter.backend.algoritms;


import com.rubio.converter.backend.algoritms.utils.FeatureWeight;
import com.rubio.converter.backend.algoritms.utils.Filters;
import com.rubio.converter.backend.algoritms.utils.ImgDecompose;
...
public class FusionEnhance {
	...
	public static Mat enhance (Mat image, int level) {
		...
		Mat matWithoutAlpha = new Mat();
		Imgproc.cvtColor(image, matWithoutAlpha, Imgproc.COLOR_BGRA2BGR);
		image = matWithoutAlpha;
...
//		return ImgDecompose.fuseTwoImageToRGB(w1, img1, w2, img2, level);
	}
